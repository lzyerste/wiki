---
title: log2_c9f2ec801fb644a0960a384d0abef605
---

# log2

```jsx
boot-repair-4ppa125                                              [20210210_0346]
...
Timeout: 1 seconds
BootOrder: 0002,0000
Boot0000* ubuntu	HD(1,GPT,1d1569cf-1e97-485b-9585-426e55d910a9,0x800,0x100000)/File(EFIUBUNTUSHIMX64.EFI)
Boot0002* UEFI: USB 2.0 USB Flash Drive 0.00, Partition 2	PciRoot(0x0)/Pci(0x1,0x2)/Pci(0x0,0x0)/Pci(0x8,0x0)/Pci(0x0,0x3)/USB(5,0)/USB(3,0)/HD(2,MBR,0x40e805e8,0x1dde000,0x10000)..BO
...
Found linux image: /boot/vmlinuz-5.10.0-custom
Found initrd image: /boot/initrd.img-5.10.0-custom
...
File descriptor 63 (pipe:[101156]) leaked on lvs invocation. Parent PID 43685: /bin/sh
umount: /lib/x86_64-linux-gnu/libmount.so.1: version `MOUNT_2_35' not found (required by umount)
rmdir: failed to remove '/var/lib/os-prober/mount': Device or resource busy
device-mapper: reload ioctl on osprober-linux-sda2  failed: Device or resource busy
Command failed.
rmdir: failed to remove '/var/lib/os-prober/mount': Device or resource busy
Adding boot menu entry for UEFI Firmware Settings
umount: /mnt/boot-sav/sdb2/dev: target is busy.
mount: /mnt/boot-sav/sda1: /dev/sda1 already mounted or mount point busy.
mount: /mnt/boot-sav/sda1: /dev/sda1 already mounted or mount point busy.
...
Please do not forget to make your UEFI firmware boot on the Ubuntu 20.04.1 LTS entry (sdb1/EFI/ubuntu/shimx64.efi file) !
...
Timeout: 1 seconds
BootOrder: 0002,0000
Boot0000* ubuntu	HD(1,GPT,1d1569cf-1e97-485b-9585-426e55d910a9,0x800,0x100000)/File(\EFI\UBUNTU\SHIMX64.EFI)
Boot0002* UEFI: USB 2.0 USB Flash Drive 0.00, Partition 2	PciRoot(0x0)/Pci(0x1,0x2)/Pci(0x0,0x0)/Pci(0x8,0x0)/Pci(0x0,0x3)/USB(5,0)/USB(3,0)/HD(2,MBR,0x40e805e8,0x1dde000,0x10000)..BO
...
sdb2          112.1G  44% /mnt/boot-sav/sdb2
...
search.fs_uuid 795fb13e-fecb-4fc4-a306-8a27b94904f1 root hd1,gpt2 
...
Ubuntu, with Linux 5.8.0-43-generic   795fb13e-fecb-4fc4-a306-8a27b94904f1
...
UUID=CAEB-A2AD  /boot/efi       vfat    defaults      0       1
...
==================== sdb2: Location of files loaded by Grub ====================
           ...
           GiB - GB             File                                 Fragment(s)
   0.500988007 = 0.537931776    boot/grub/grub.cfg                             1
...
hexdump: /dev/nvme0n1p4: No such file or directory
File descriptor 63 (pipe:[101156]) leaked on lvs invocation. Parent PID 8592: /bin/bash
```